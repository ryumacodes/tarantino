            ...
            match event.id.as_ref() {
                ...
                "quit" => {
                    ...
                    tauri::async_runtime::spawn(async move {
                        ...
                        let state = handle.state::<Arc<UnifiedAppState>>();
                        commands::lifecycle::release_recording_surfaces(
                            &handle,
                            Some(state.inner()),
                            "tray quit",
                        );
...
async fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            permissions::open_camera_preferences,
            ...
            commands::device::refresh_windows,
