...
#[tauri::command]
pub async fn get_selected_display(
    state: State<'_, Arc<UnifiedAppState>>,
) -> Result<Option<state::Display>, String> {
...
pub async fn get_displays_with_thumbnails(
    ...
    state
        .get_displays_with_thumbnails()
        .await
        .map_err(|e| e.to_string())
}

#[tauri::command]
pub async fn get_display_bounds(
    display_id: String,
    state: State<'_, Arc<UnifiedAppState>>,
...
pub async fn get_windows(
    state: State<'_, Arc<UnifiedAppState>>,
) -> Result<Vec<state::Window>, String> {
...
pub async fn refresh_windows(
    ...
    state.refresh_windows().await.map_err(|e| e.to_string())
}

#[tauri::command]
pub async fn get_devices(
    state: State<'_, Arc<UnifiedAppState>>,
) -> Result<Vec<state::Device>, String> {
